...
description: "Making a Shiny app for record diggers to explore and visualize their collections."
date: "2017-03-01"
tags: ["r", "shiny", "discogs", "api"]
---
...
knitr::include_graphics("/img/2017-03-01-Vinylspotting/Discogs collection page.png")
```
...
The obvious next thought was, "R could probably help with that".[^fullcode]
...
my_collection <- getCollection("ewen_henderson")

as_tibble(my_collection)
```
...
```{r echo = FALSE, out.width = "75%", fig.align = "center"}
knitr::include_graphics("https://github.com/ewenme/vinylspotting/raw/master/vinyspotting_preview.gif")
```
...
[^fullcode]: To keep the post concise I don't show all of the code, especially code that generates figures. But you can find the full code [here](https://github.com/rbind/ewenme/blob/master/content/blog/vinylspotting-discogs-fairytale.Rmd).
