...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, fig.width = 8, fig.height = 6, out.width = 625, dpi = 180)
...
![](https://i1.wp.com/hypebeast.com/image/2015/08/kanye-west-to-perform-whole-808s-heartbreak-album-1.jpg?quality=95&w=625)
...
tidy_df %>%
  ...
  theme_ipsum(grid="X", base_size = 16, axis_title_size = 16, caption_size = 12,
              plot_title_size = 20, subtitle_size = 16) +
...
![](http://deathofthecritic.com/index_files/kanye.png)
...
![](https://images.rapgenius.com/lo819l8o8xjarydi10ur9r0d.525x350x4.gif)
...
by_album_sentiment %>%
  ...
  geom_line(size=1.5) +
  theme_ipsum(base_size = 16, axis_title_size = 16, grid="Y", caption_size = 12,
              plot_title_size = 20, subtitle_size = 16) +
  scale_color_ipsum() +
...
![Murakami's design for "Graduation"](http://www.resizr.com/resized/f624.jpg)
...
![Condo's designs for "My Beautiful Dark Twisted Fantasy"](http://www.resizr.com/resized/40c2.jpg)
...
![](http://www.iamdashet.com/wp-content/uploads/2012/03/kanyezone-450x280.jpg)

<br>

[^fullcode]: To keep the post concise I don't show all of the code, especially code that generates figures. But you can find the full code [here](https://github.com/ewenme/ewenme.github.io/blob/master/_R/2017-03-20-Kanye_sentiment_analysis.Rmd).
