...
type: "post"
categories: ["R"]
tags: ["blogdown", "R", "geofacet", "london"]
excerpt: "A look at London's pubs and bars with the geofacet package."
---
...
[^fullcode]: To keep the post concise I don't show all of the code, especially code that generates figures. But you can find the full code [here](https://github.com/rbind/ewenme/blob/master/content/blog/2017-05-30-geofacet_ldn_pubs.Rmd).