...
To tamper with type, we mostly care about [Cascading Stylesheets](https://bookdown.org/yihui/blogdown/css.html) (CSS). For more on CSS, I will again direct you to Yihui et al's wicked book instead of regurgitating the same messages less coherently. Among other things, you'll learn that your Hugo theme (found in the `/themes` folder of your site's repository) usually stores CSS files in a `/static/css` sub-folder, where you can freely edit the complete look and feel of your site. 
