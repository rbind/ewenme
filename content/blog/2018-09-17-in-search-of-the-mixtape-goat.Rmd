...
cover: https://github.com/rbind/ewenme/raw/master/public/img/2018-09-17-in-search-of-the-mixtape-goat/datpiff-bubble.png
draft: no
---
...
```{r out.width="75%"}
knitr::include_graphics("/img/2018-09-17-in-search-of-the-mixtape-goat/xxx-art.jpg")
```
...
```{r out.width="75%"}
knitr::include_graphics("/img/2018-09-17-in-search-of-the-mixtape-goat/nostalgia-ultra-art.jpg")
```
...
```{r out.width="75%"}
knitr::include_graphics("/img/2018-09-17-in-search-of-the-mixtape-goat/datpiff-screenshot.png")
```
