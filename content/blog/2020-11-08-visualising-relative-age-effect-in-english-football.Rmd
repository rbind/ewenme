---
title: visualising relative age effect in English football
date: '2020-11-08'
slug: visualising-relative-age-effect-in-english-football
tags:
  - football
  - data-viz
...
image: "/blog/2020-11-08-visualising-relative-age-effect-in-english-football_files/figure-html/rae-chart-1.png"
draft: no
---
...
```{r rae-chart, fig.height=8, fig.width=6}
ggplot(data = eng_player_bdays, aes(x=month, y=prop)) +
  ...
  geom_label(aes(label = label), family="Recursive") +
  # add personal chart theme
  theme_ewen_rs(axis = FALSE, plot_title_size = 14, base_size = 11.5) + 
  ...
  labs(
    ...
    subtitle="Current (2020/21 season) participation of English-born players in the\ntop four English football divisions is skewed towards those born early\nafter the age group competition cut-off date (31st August)",
