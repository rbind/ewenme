...
ggplot(data = eng_player_bdays, aes(x=month, y=prop)) +
  ...
  labs(
    ...
    subtitle="Current (2020/21 season) participation of English-born players in the<br>top four English football divisions is skewed towards those born early<br>after the age group competition cut-off date (31<sup>st</sup> August)",
