...
showonlyimage: false
draft: false
image: "blog/img/vinylspotting.png"
weight: 0
type: "post"
description: "Developing a Shiny app to explore and visualize record collections."
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(cache=TRUE, echo = TRUE, tidy = TRUE, warning = FALSE, message = FALSE, out.width = 625, dpi = 180)
```
...
[^fullcode]: To keep the post concise I don't show all of the code, especially code that generates figures. But you can find the full code [here](https://github.com/rbind/ewenme/blob/master/content/blog/2017-03-01-Vinylspotting.Rmd).
