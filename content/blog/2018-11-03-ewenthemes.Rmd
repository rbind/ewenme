...
knitr::opts_chunk$set(cache = FALSE, warning = FALSE, message = FALSE, echo = FALSE, out.width = '75%', dev = c('svg', 'png'), fig.align='center')
```
...
Following Bob's lead, I chose to ship [Work Sans](https://github.com/weiweihuanghuang/Work-Sans) inside the software and include functions to install it on your system with help from `extrafont`. Font handling is surprisingly tricksy in R and this seems to be the best option right now.
