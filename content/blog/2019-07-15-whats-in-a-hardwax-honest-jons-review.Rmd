...
[^fullcode]: To keep the post concise and pretty for non-coders, I don't show the code. You can find the code [here](https://github.com/rbind/ewenme/blob/master/content/blog/2019-07-09-diggin-into-hardwax-honest-jons-reviews.Rmd).
