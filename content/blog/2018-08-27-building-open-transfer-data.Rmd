...
# get data
epl_transfers <- read_csv(file="https://raw.githubusercontent.com/ewenme/transfers/master/data/1992/english_premier_league.csv")
...
Et voila - the data is now freely available, [hosted on Github as flat .csv files](https://github.com/ewenme/transfers/tree/master/data) (in accordance with Transfermarkt's [terms of use](https://www.transfermarkt.co.uk/intern/anb))[^legal]. Here's a preview, lovingly featuring the deal taking Mr. Keown to Arsenal.
