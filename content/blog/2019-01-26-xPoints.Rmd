...
ggplot(player_stats, aes(x = xG_90, y = xA_90)) +
  ...
  # add chart labels
  labs(title = "Expected goals contributions, midfielders vs. forwards",
       subtitle = "Expected goals (xG) and expected assists (xA) per 90 mins.\nPositions as defined in Fantasy Premier League (FPL).\nPlayers with less than 900 minutes removed.",
