...
description: "Dissecting some fantasy football falsehoods with my newest R package."
date: "2017-06-25"
tags: ["r", "package", "fpl", "fplr"]
---

```{r setup, include=FALSE}

knitr::opts_chunk$set(cache=TRUE, echo = TRUE, warning = FALSE, message = FALSE, out.width = '100%', dpi = 180, echo = FALSE, dev = 'svg')
...
playersDetailed %>%
  ...
  labs(title="Ownership Booms & Busts",
       ...
       x="Player", y="Net ownership change (%)")
```
...
playersDetailed %>%
  ...
  labs(title="Average Points of Top Point Scoring Players",
       x="Gameweek", y="Points average (last 5 GWs)") +
  facet_wrap( ~ as_factor(web_name), nrow = 2, ncol = 4)
