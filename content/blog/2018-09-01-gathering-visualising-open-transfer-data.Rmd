...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo = FALSE, out.width = '100%', dev = 'svg')
...
Around this time last year I ran [a post on European football transfers](https://ewen.io/2017/09/07/unravelling-the-european-football-transfer-window/), taking in the 2017/18 season's summer window. I got a bit of an itch to refresh this work when the 2018/19 window hit. The aforementioned itch naturally led me to getting in too deep and scraping all major European league transfers going back to the year 2000(!), of course. 

Here, I tell a short story about how the open data was built and showcases some visualisation pieces that utilised that effort. I hope this can encourage others to share whatever neat stuff they tap into.[^code]
...
Now for a couple of visualisation pieces I've tried out using this dataset. I've included some notes on my process/workflow for each[^viz], if you're that way inclined. Otherwise, just ~absorb the inspiration~ `r emo::ji("sun")`

#### League clubs' spend vs sales with Cleveland dots

I took a look at the value of player buys vs sales for Premier League clubs in the 2018/19 window, using a [Cleveland dot plot](https://uc-r.github.io/cleveland-dot-plots) (AKA the 'dumbbell' chart, made simple with ) variant. 
...
#### Club's historic spend/sales profile with connected scatters

This time, a look at a single club's season-by-season transfer spend and sales, following the relationship between these two amounts through time.  
