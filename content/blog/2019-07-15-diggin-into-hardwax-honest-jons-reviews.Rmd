...
image: "/blog/2019-07-15-diggin-into-hardwax-honest-jons-reviews_files/figure-html/hj-specific-common-1.png"
draft: no
---
...
[Honest Jons](https://honestjons.com) of London and [Hardwax](https://hardwax.com/) of Berlin are undisputed record store royalty. Both are 30+ years in the game but maintain a fiercely independent and unapolagetic representation of music in their city, and beyond. This rep extends to their online presence, most infamously through the unique style in which each store's staff break down the new stuff hitting the shelves. 
...
ggplot(data = records, aes(x = store)) +
  ...
  labs(title = "Record store review counts",
       subtitle = "# of Harwax and Honest Jons reviews of records present in the data.",
...
desc = '"Jazz" and "Music" are both extremely common and unique (vs. Hardwax) review words.'
word_log_odds %>% 
  ...
  geom_mark_ellipse(aes(filter = count > 500, description = desc), 
                    label.fontsize = 9, label.family = "Work Sans Light") +
  scale_x_log10() +
  theme_ewen_ws(axis = FALSE, grid = "XY", plot_title_size = 16, subtitle_size = 12, 
                base_size = 12) +
  labs(title = "Honest Jons specific / common review words",
       subtitle = "The most frequently occuring and most characteristic words in Honest Jons\nrecord reviews.",
...
ggplot(hj_review_word_counts, aes(x = fct_reorder(category, -word_count), y = word_count)) + 
  geom_sina(alpha = 0.15, colour = ghibli_palettes$KikiMedium[7]) +
  scale_y_continuous(expand = c(0, 0)) +
  theme_ewen_ws(plot_title_size = 18, subtitle_size = 12, base_size = 14) +
  theme(axis.text.x = element_text(size = 10)) +
  labs(title = "Honest Jons review lengths",
       subtitle = "The word counts of Honest Jons reviews, by site category. Ordered by\nmedian review length (descending, left to right).",
